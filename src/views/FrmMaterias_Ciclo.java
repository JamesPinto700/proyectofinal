...
import views.tables.Modelo_de_Tabla;
 ...
 * @author Carlos Zumba
 */
public class FrmMaterias_Ciclo extends javax.swing.JDialog {
    ...
    public FrmMaterias_Ciclo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarCarrera();
    ...
    private void initComponents() {
        ...
        CxbCarrera.setBounds(110, 100, 160, 30);

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel3.setText("Ciclo:");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(280, 100, 70, 30);
        ...
        tbtMaterias.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Numero", "Title 2", "Title 3", "Title 4", "Title 5"
            }
        ));
        ...
        jPanel1.add(jPanel4);
        jPanel4.setBounds(10, 160, 460, 480);
        ...
        cbxciclos.setBounds(350, 100, 100, 30);
        ...
        jTextField5.setBounds(630, 360, 71, 30);
        ...
        jLabel10.setBounds(570, 360, 60, 20);
        ...
        jPanel1.add(jLabel7);
        jLabel7.setBounds(560, 320, 60, 20);
        ...
        txtcredito.setBounds(630, 320, 90, 30);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 10, 860, 660);

        setSize(new java.awt.Dimension(879, 675));
        ...
        if (null == carrera) {
            ...
            switch (carrera) {
                ...
                case "Telecomunicaciones" -> {
                    rellenarComboCiclos("data.Telecomunicaciones");
...
// TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if ((jTextField1.getText().isEmpty() && jTextField3.getText().isEmpty() && jTextField1.getText().isEmpty() && jTextField4.getText().isEmpty() && jTextField5.getText().isEmpty())) {
        ...
        String materianueva = (jTextField1.getText() + "\t" + "ciclo" + "\t" + jTextField3.getText() + "\t" + jTextField4.getText() + "\t" + jTextField5.getText() + "\t" + txtcredito.getText() + "\n");
        try {
            switch (carrera) {
                case "Computacion":
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMaterias_Ciclo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmMaterias_Ciclo dialog = new FrmMaterias_Ciclo(new javax.swing.JFrame(), true);
